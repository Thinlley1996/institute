...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'Your institute name';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['my_class_id', 'section_id', 'year_admitted', 'house', 'age'];
    ...
    {
       switch($class_type){
           case 'WB' : return 'Web Development';
           case 'D' : return 'Designing';
           case 'A' : return 'Animation';
           case 'BG' : return 'Bg Artist';
           case 'M' : return 'Music Artist';
           case 'V' : return 'VFX';
       }
        return $class_type;
    }
