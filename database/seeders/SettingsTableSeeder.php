...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'DRC'],
            ['type' => 'system_name', 'description' => 'Department of Revenue and Custom'],
            ['type' => 'term_ends', 'description' => '7/10/2018'],
            ['type' => 'term_begins', 'description' => '7/10/2018'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'Main traffic, Thimphu'],
            ['type' => 'system_email', 'description' => 'thinley@gmail.com'],
